...
public class TradeOrderActionTest extends TestCase {
	...
	public void testLogin() throws Exception {
		CtpClient.ctp(HOST, PORT, UserLoginReqHandler.newInstance());
	...
	public void testLoginAndOrderAction() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), 6971,
	...
	static class UserLoginReqHandler implements ChannelFutureListener {
		...
		static UserLoginReqHandler newInstance() {
			return new UserLoginReqHandler();
		}
		...
		public void operationComplete(ChannelFuture future) throws Exception {
			...
			FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), 6960,
					TID.UserLoginReq.id());
