...
import io.ffreedom.ftd.pool.FtdClientPool;
 ...
 * SIMNOW地址:<br>
 * 
 * 180.168.146.187:10000 <br>
 * 180.168.146.187:10030 <br>
 * brokerId:9999<br>
 * 
 * @OriginalAuthor ee
 * 
...
public class PoolTradeTest extends TestCase {
	...
	public void testLoginAndConstractBank() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.ContractbankReq.id(), Sequence.ContractBank);
	...
	public void testLoginAndLogout() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.UserLogoutReq.id(), Sequence.UserLogout);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndSettlementInfo() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.SettlementInfoReq.id(), Sequence.SettlementInfo);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndSettlementInfoConfirm() throws Exception {
		...
		info.write(buffer.retain());
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.SettlementInfoConfirmReq.id(), Sequence.SettlementInfoConfirm);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndQrySettlementInfoConfirm() throws Exception {
		...
		info.write(buffer.retain());
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QrySettlementInfoConfirmReq.id(), Sequence.QrySettlementInfoConfirm);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndTradingAccount() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.TradingAccountReq.id(), Sequence.TradingAccount);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndOrderInsert() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.OrderInsertReq.id(), Sequence.OrderInsert);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndInvestorPosition() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.InvestorPositionReq.id(), Sequence.InvestorPosition);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndQryOrder() throws Exception {
		...
		order.write(buffer.retain());
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QryOrderReq.id(), Sequence.QryOrder);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndQryTrade() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QryTradeReq.id(), Sequence.QryTrade);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndQryMarginRate() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QryMarginRateReq.id(), Sequence.QryMarginRate);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndQryCommissionRate() throws Exception {
		...
		rate.write(buffer.retain());
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QryCommissionRateReq.id(), Sequence.QryCommissionRate);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndAccountRegister() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.AccountRegisterReq.id(), Sequence.AccountRegister);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testQryTransferSerial() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QryTransferSerialReq.id(), Sequence.QryTransferSerial);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testQryInstrument() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.QryInstrumentReq.id(), Sequence.QryInstrument);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testFromBankToFuture() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.FromBankToFutureReq.id(), Sequence.FromBankToFuture);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testFromFutureToBank() throws Exception {
		...
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.FromFutureToBankReq.id(), Sequence.FromFutureToBank);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndOrderAction() throws Exception {
		...
		order.write(buffer.retain());
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.OrderActionReq.id(), Sequence.OrderAction);
		ftdcChannel.writeAndFlush(ftdc);
	...
	public void testLoginAndUserPasswordUpdate() throws Exception {
		...
		order.write(buffer.retain());
		FtdcProtocol ftdc = new FtdcProtocol(FtdType.FTDTypeCompressed, buffer, FtdcType.REQ.type(), ri.getReqId(),
				TID.UserPasswordUpdateReq.id(), Sequence.UserPasswordUpdate);
		ftdcChannel.writeAndFlush(ftdc);
