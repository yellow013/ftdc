...
public class FtdcDecoder extends ByteToMessageDecoder {
	 ...
	 */
	public FtdcDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength) {
	 ...
	 */
	public FtdcDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment,
	 ...
	 *            has been read.
	 */
	public FtdcDecoder(ByteOrder byteOrder, int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
