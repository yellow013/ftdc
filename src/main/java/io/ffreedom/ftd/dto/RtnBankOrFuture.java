...
/**
 * 
 * @author zlj 2017年10月17日 下午8:20:35
 *
 */
public class RtnBankOrFuture implements FtdcRsp {
	// 7
	...
	/**
	 * @param verifyCertNoFlag
	 *            the verifyCertNoFlag to set
	 */
	...
	/**
	 * @param futureFetchAmount
	 *            the futureFetchAmount to set
	 */
	...
	/**
	 * @param bankSecuAccType
	 *            the bankSecuAccType to set
	 */
	...
	/**
	 * @param brokerIDByBank
	 *            the brokerIDByBank to set
	 */
	...
	/**
	 * @param longCustomerName
	 *            the longCustomerName to set
	 */
	...
	@Override
	public RtnBankOrFuture parseFrom(ByteBuf body, RspError error) {
		RtnBankOrFuture info = new RtnBankOrFuture();
		...
		try {
			info.setCustomerName(
					StringUtils.trimToEmpty(new String(customerName, ApplicationRuntime.conf().defaultEncoding())));
		...
		try {
			info.setLongCustomerName(
					StringUtils.trimToEmpty(new String(longCustomerName, ApplicationRuntime.conf().defaultEncoding())));
		} catch (UnsupportedEncodingException e) {
			// nop
		}
	...
	public String toString() {
		return "RtnFromBankToFuture [tradeCode=" + tradeCode + ", bankID=" + bankID + ", bankBranchID=" + bankBranchID
				+ ", brokerID=" + brokerID + ", brokerBranchID=" + brokerBranchID + ", tradeDate=" + tradeDate
				+ ", tradeTime=" + tradeTime + ", bankSerial=" + bankSerial + ", tradingDay=" + tradingDay
				+ ", plateSerial=" + plateSerial + ", lastFragment=" + lastFragment + ", sessionID=" + sessionID
				+ ", customerName=" + customerName + ", idCardType=" + idCardType + ", identifiedCardNo="
				+ identifiedCardNo + ", custType=" + custType + ", bankAccount=" + bankAccount + ", bankPassWord="
				+ bankPassWord + ", accountID=" + accountID + ", password=" + password + ", installID=" + installID
				+ ", futureSerial=" + futureSerial + ", userID=" + userID + ", verifyCertNoFlag=" + verifyCertNoFlag
				+ ", currencyID=" + currencyID + ", tradeAmount=" + tradeAmount + ", futureFetchAmount="
				+ futureFetchAmount + ", feePayFlag=" + feePayFlag + ", custFee=" + custFee + ", brokerFee=" + brokerFee
				+ ", message=" + message + ", digest=" + digest + ", bankAccType=" + bankAccType + ", deviceID="
				+ deviceID + ", bankSecuAccType=" + bankSecuAccType + ", brokerIDByBank=" + brokerIDByBank
				+ ", bankSecuAcc=" + bankSecuAcc + ", bankPwdFlag=" + bankPwdFlag + ", secuPwdFlag=" + secuPwdFlag
				+ ", operNo=" + operNo + ", requestID=" + requestID + ", tID=" + tID + ", transferStatus="
				+ transferStatus + ", errorID=" + errorID + ", errorMsg=" + errorMsg + ", longCustomerName="
				+ longCustomerName + "]";
	}
