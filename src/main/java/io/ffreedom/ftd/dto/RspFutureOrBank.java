 ...
 * 
 * @author wyz
 * 2017年10月17日 下午8:19:13
 *
 */
public class RspFutureOrBank implements FtdcRsp{
	// 4
	...
	@Override
	public RspFutureOrBank parseFrom(ByteBuf body, RspError error) {
		RspFutureOrBank info = new RspFutureOrBank();
	...
	public String toString() {
		return "RspFutureOrBank [tradeCode=" + tradeCode + ", bankID=" + bankID + ", bankBranchID=" + bankBranchID
				...
				+ transferStatus + ", longCustomerName=" + longCustomerName + "]";
	}
