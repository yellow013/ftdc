 ...
 * 
 * @author ee 2017年10月17日 下午8:27:04
 *
 */
public class FtdcProtocol {
	 ...
	 * @param ftdcBody
	 * @param ftdcType
	 *            协议类型：REQ或者RSP，根据此类型的不同，sequence不同
	 * @param reqId
	 * @param tid
	 * @param sequence
	 */
	 ...
	 * head----------------------------------------------------|------ftdc
	 * body-------|<br/>
	 * 头部格式|--version--|--type--|--ul--|--chain--|--stype--|--sequence--|--cs--|--num--|--len--|--reqid--|--tid--|--tlen--|------ftdc
	 * body-------|<br/>
	 * 长度大小|-----1-----|----1---|---1--|----1----|----2----|------4-----|---4--|---2---|----2--|-----4---|---2---|----2---|------0~65535---------|
	 * 
	 * @author ee 2017年11月10日 下午5:41:06
	 *
	 */
	public static class Ftdc {
		...
		public String toString() {
			return "Ftdc [version=" + version + ", type=" + type + ", unencodeLength=" + unencodeLength + ", chain="
					+ chain + ", sequenceType=" + sequenceType + ", sequence=" + sequence + ", unknown="
					+ currentSequence + ", numData=" + numData + ", ftdcLen=" + ftdcLen + ", reqId=" + reqId + ", tid="
					+ tid + "]";
		}
	 ...
	 * 长度: |-----1-------|------1--------|--0~255-------|
	 * 
	 * @author ee 2017年11月10日 下午5:36:45
	 *
	 */
